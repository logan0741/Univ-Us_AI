...
| 문서 | 언제 |
| --- | --- |
| [**docs/SSH-서버-접속-가이드.md**](docs/SSH-서버-접속-가이드.md) | 학교 Jupyter/GPU 서버에 SSH·VS Code Remote-SSH 로 접속할 때 |
...
> ### 학교 서버에서 개발한다면
> 본인 PC가 아니라 학교 Jupyter/GPU 서버에서 작업할 계획이면,
> **[docs/SSH-서버-접속-가이드.md](docs/SSH-서버-접속-가이드.md) 를 먼저 보고 접속부터 하세요.**
> SSH 설정, VS Code Remote-SSH 연결, "비밀번호를 물어봐요" 같은 문제 해결이 정리돼 있습니다.

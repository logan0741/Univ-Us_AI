...
echo
echo " 다음 할 일"
echo "   1. 카드는 전부 Todo 에 들어갑니다. 그대로 두세요"
echo "   2. 이슈마다 담당자(assignee)를 지정하세요"
echo "   3. 시작할 때만 In Progress 로 옮깁니다 — 1인 최대 2장"
echo "      옮기기 전에 이슈의 완료 기준이 비어 있지 않은지 확인하세요"
echo
echo " 자세한 규칙: docs/DEV_PLAN.md 6장"
echo "============================================================"
